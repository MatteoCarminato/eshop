                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>William PVT</td>
                                                    <td>Sep 27, 2021</td>
                                                    <td><img src="{{ asset('assets/images/users/avatar-3.jpg') }}"
                                                            alt=""
                                                            class="avatar-xs rounded-circle me-2 material-shadow">
                                                    ...
                                                    <td><span
                                                            class="badge bg-danger-subtle text-danger p-2">Stuck</span>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>Loiusee LLP</td>
                                                    <td>Sep 30, 2021</td>
                                                    <td><img src="{{ asset('assets/images/users/avatar-4.jpg') }}"
                                                            alt=""
                                                            class="avatar-xs rounded-circle me-2 material-shadow">
                                                        <a href="#javascript: void(0);"
                                                    ...
                                                    <div class="avatar-group">
                                                        ...
                                                        <div class="avatar-group-item material-shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block"
                                                                ...
                                                                <img src="{{ asset('assets/images/users/avatar-6.jpg') }}"
                                                                    alt="" alt="" class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item material-shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block"
