                                ...
                                <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Absternet LLC</td>
                                            <td>Sep 20, 2021</td>
                                            <td><img src="{{ asset('assets/images/users/avatar-1.jpg') }}" alt=""
                                        ...
                                        <tr>
                                            <td>William PVT</td>
                                            <td>Sep 27, 2021</td>
                                            <td><img src="{{ asset('assets/images/users/avatar-3.jpg') }}" alt=""
                                                    class="avatar-xs rounded-circle me-2 material-shadow">
                                        ...
                                        <tr>
                                            <td>Loiusee LLP</td>
                                            <td>Sep 30, 2021</td>
                                            <td><img src="{{ asset('assets/images/users/avatar-4.jpg') }}" alt=""
                                                    class="avatar-xs rounded-circle me-2 material-shadow">
                                        ...
                                        <tr>
                                            <td>Apple Inc.</td>
                                            <td>Sep 30, 2021</td>
                                            <td><img src="{{ asset('assets/images/users/avatar-6.jpg') }}" alt=""
                                                    class="avatar-xs rounded-circle me-2 material-shadow">
                                                <a href="#javascript: void(0);" class="text-body fw-medium">Vitoria
                                                    Rodrigues</a>
                                            </td>
                                            <td><span class="badge bg-info-subtle text-info p-2">New
                                                    Lead</span>
                                            </td>
                                            <td>
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1">
                                                <label class="form-check-label mb-0 ps-2" for="task_four">Add
                                                    notes that can be viewed from the individual
                                                    view</label>
                                            </div>
                                            <div class="flex-shrink-0 ms-2">
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1">
                                                <label class="form-check-label mb-0 ps-2" for="task_six">Styling
                                                    wireframe design and documentation for velzon
                                                    admin</label>
                                            </div>
                                            <div class="flex-shrink-0 ms-2">
                                                <p class="text-muted fs-12 mb-0">27 Sep, 2021</p>
                                ...
                                <li class="list-group-item ps-0">
                                    <div class="row align-items-center g-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <a href="#" class="text-reset fs-14 mb-0">Meeting for campaign
                                                with
                                                sales team</a>
                                        </div>
                                ...
                                <li class="list-group-item ps-0">
                                    <div class="row align-items-center g-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <a href="#" class="text-reset fs-14 mb-0">Adding a new event
                                                with
                                                attachments</a>
                                        </div>
                                        <div class="col-sm-auto">
                                ...
                                <li class="list-group-item ps-0">
                                    <div class="row align-items-center g-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <a href="#" class="text-reset fs-14 mb-0">Weekly closed sales
                                                won
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-nowrap align-middle mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>William PVT</td>
                                            <td><img src="{{ asset('assets/images/users/avatar-7.jpg') }}" alt=""
                                                    class="avatar-xs rounded-circle me-2 material-shadow">
